...
export const Header = () => {
  ...
  return (
    <header className="sticky left-0 right-0 top-0 flex justify-center border-b border-zinc-200 dark:border-slate-400 bg-white transition-all duration-500 dark:bg-slate-600">
