...
export const Footer = () => {
  ...
  return (
    <footer className="sticky bottom-0 left-0 right-0 flex justify-center border-t border-zinc-200 bg-white transition-all duration-500 ease-in-out dark:border-slate-400 dark:bg-slate-600 dark:text-white">
      {/* inner content */}
